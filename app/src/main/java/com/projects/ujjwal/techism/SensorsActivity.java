...
public class SensorsActivity extends Activity implements SensorEventListener, LocationListener {
	...
	private String message,xCoordinate,yCoordinate;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		intent.putExtra("xCoordinate1",xCoordinate);
		intent.putExtra("yCoordinate1",yCoordinate);
	...
	public void onStart() {
		...
		try {
			...
			try {
				...
				hardFix.setLatitude(23.7957);
				hardFix.setLongitude(86.4304);
	...
	public void onSensorChanged(SensorEvent event) {
		...
		Log.d("angle", String.valueOf(floatBearing));

		Intent intent=new Intent(this,TtsActivity.class);
		String angle = String.valueOf(floatBearing);
